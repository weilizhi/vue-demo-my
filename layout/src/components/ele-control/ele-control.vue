<template>
  <div class="cart-control">
    <transition name="cartControlRemove">
      <i class="remove icon-remove_circle_outline" v-show="food.count>0" @click="removeCount"></i>
    </transition>
    <transition name="cartControlRemove">
...
export default {
  name: "ele-control",
  props: {
    food: { type: Object, require: true },
    goodIndex: { type: Number, require: false },
    foodIndex: { type: Number, require: false }
  },
